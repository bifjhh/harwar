...
function (e) {
    ...
    i.getQueryString = function (e) {
        ...
        for (var t, n = document.getElementsByTagName("script"), i = 0; t = n[i++];)
            if ("interactive" === t.readyState) return t.className = t.src
        ...
        a.getListeners = function (e) {
            ...
            for (o in r)
                if (r.hasOwnProperty(o))
                    for (i = r[o].length; i--;) n = r[o][i], n.once === !0 && this.removeListener(e, n.listener), n.listener.apply(this, t || []) === this._getOnceReturnValue() && this.removeListener(e, n.listener);
            return this
